...
export interface ScreenProps {
  ...
  mainAction?: ActionItem | (() => ActionItem);
  ...
  // Unique ID for logging and identification in debugging
  // In production component names are obfuscated and so this
  // is useful for clear logging and debugging.
  id?: string;
}
