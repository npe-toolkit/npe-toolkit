...
import {addProviderScope} from '@toolkit/core/providers/Server';
...
export function providersMiddleware(providers: any[]): Middleware {
  return async (
    _ctx: FirebaseCtx,
    _reqData: any,
    _respData: any,
...
export const RolesCheckMiddleware: Middleware = async (
  ...
  if (handlerConfig != null && handlerConfig.allowedRoles != null) {
    ...
    const allowed = normalizedRoles.some(role => roles.includes(role));
    if (!allowed) {
