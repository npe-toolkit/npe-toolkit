...
import {providerKeyFor} from '@toolkit/core/providers/Providers';
...
const StatusApiKey = providerKeyFor<StatusApi>();
...
export const StatusContainer = (props: StatusContainerProps) => {
  ...
  const [errorValue, setErrorValue] = React.useState<Opt<Error>>(null);
  const [messageValue, setMessageValue] = React.useState<Opt<string>>(null);
...
export const SimpleUserMessaging = (props: {style?: ViewStyle}) => {
  ...
  scope.provideValue(StatusApiKey, api);
